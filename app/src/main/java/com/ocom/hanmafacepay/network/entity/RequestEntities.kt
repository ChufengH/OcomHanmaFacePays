...
data class PayRequest(@AutoField("device_no") val device_no:String,
...
data class CancelOrderRequest(val device_no: String,val trade_no: String,
...
//@Body timestamp:String,//时间戳，如1552640337
//@Body sign:String//SHA256(device_no+timestamp +秘钥)
data class HeartBeatRequest(@AutoField("device_no") val device_no: String,
                            @AutoField("timestamp") val timestamp: String,
                            @AutoField("sign") val sign: String)
